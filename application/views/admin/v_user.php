	...
	<div class="row">
		...
		<!-- div.dataTables_borderWrap -->
                            ...
                            <?php else: ?>
                                Tidak ada data
						   <?php endif?>
						   <td><a href="http://localhost/amazingartworld/index.php/admin/user/create" data-toggle="tooltip" data-placement="bottom" title="Tambah Data" class="btn btn-warning"></i> Tambah Data</a> </td>
